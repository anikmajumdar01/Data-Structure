...
template<class ItemType>
int Leaf(TreeNode<ItemType> *root)
{
    static int Count=0;
    if(root!=NULL)
    {
...
template<class ItemType>
int TreeType<ItemType>::number_Of_Leaf()
{
    return Leaf(root);
}

template<class ItemType>
int cout_height(TreeNode<ItemType> *root)
{
    int left_height,right_height,h;
    if(root==NULL)
        return 0;
    else
    {
        left_height=cout_height(root->left);
        right_height=cout_height(root->right);
    }
